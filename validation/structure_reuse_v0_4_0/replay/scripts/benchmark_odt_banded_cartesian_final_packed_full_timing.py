...
def run(args: argparse.Namespace) -> dict[str, Any]:
    ...
    result = {
        ...
        "claim_boundary": [
            ...
            f"All hot timings start with the complex camera tensor resident on the {torch.cuda.get_device_name(0)} GPU and exclude acquisition, host-to-device transfer and hologram demodulation.",
